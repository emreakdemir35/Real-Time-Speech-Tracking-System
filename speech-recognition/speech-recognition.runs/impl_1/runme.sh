...
HD_PWD='C:/Users/Emre Akdemir/Desktop/speech-recognition-project/speech-recognition/speech-recognition.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_forwarder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source uart_forwarder.tcl -notrace
