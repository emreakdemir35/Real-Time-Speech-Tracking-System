...
HD_PWD='C:/Users/Emre Akdemir/Desktop/speech-recognition-project/speech-recognition/speech-recognition.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_forwarder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_forwarder.tcl
